...
print(analyser1.df_imu[analyser1.df_imu > 10.0].count())
print(analyser2.df_imu[analyser2.df_imu > 10.0].count())
print(analyser3.df_imu[analyser3.df_imu > 10.0].count())
print(analyser4.df_imu[analyser4.df_imu > 10.0].count())
